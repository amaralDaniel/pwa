module.exports = {
  ...
  'Pin (save) a repository' : function (browser) {
    browser
      ...
      .click('#save-button')
      .pause(1000)
      .waitForElementVisible('#success-alert', 5000, false)
  ...
  'Check profile information' : function (browser) {
    browser
      ...
      .pause(1000)
      .waitForElementVisible('#profile-info', 2000, false)
  ...
  'Create an issue' : function (browser) {
    browser
      ...
      .pause(1000)
      .waitForElementVisible('#single-issue', 10000, false)
  },
  ...
  'Make a commit' : function (browser) {
    browser
      ...
      .pause(1000)
      .setValue('#create-file > div:nth-child(1) > div.flex.xs8.sm6 > div > div.input-group__input > input[type="text"]', 'test_file.py')
  ...
  'Create a repository' : function (browser) {
    browser
      .useCss()
      .click('#app > div > nav > div.toolbar__content > a:nth-child(2) > button')
      .pause(1000)
      .waitForElementVisible('create-repo-container', 10000, false)
      .setValue('#create-repo-container > form > div.layout.row.wrap > div.flex.xs8.sm8 > div > div.input-group__input > input[type="text"]', 'test-repo')
      ...
      .click('#app > div.menu__content.menu__content--select.menu__content--autocomplete.menuable__content__active > div > ul > li')
      .pause(1000)
      .click('#create-repo-container > form > div.input-group.input-group--dirty.radio-group.radio-group--column > div.input-group__input > div.input-group.input-group--active.input-group--selection-controls.radio.primary--text')
      .pause(1000)
